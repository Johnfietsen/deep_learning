"""
This module implements training and evaluation
of a multi-layer perceptron inNumPy.
...
def train():
    ...
    while i < FLAGS.max_steps and np.linalg.norm(dx) > 1e-5:
        ...
        ce_out = cross_entropy.forward(nn_out, y_batch)
        dx = cross_entropy.backward(nn_out, y_batch)
        neural_network.backward(dx)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dnn_hidden_units', type=str, \
                      ...
                      help='Comma separated list of number of units in each \
                            hidden layer')
